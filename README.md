...
## Firmware
Made with VSCode + PlatformIO using some HAL drivers. Source code is provided: just clone the repo and open the project with PIO VSCode plugin. The last binary is [HERE]()
